all:
	...
	@i386-elf-gcc -T linker.ld -o build/neobird.bin -ffreestanding -O2 -nostdlib build/boot.o build/kernel.o -lgcc
	...
	# make the iso file
	-grub-mkrescue -o build/neobird.iso iso > /dev/null 2>&1 # i dont wanna hear it